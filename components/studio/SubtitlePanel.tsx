        ...
        <div className="flex flex-col h-full bg-[#1e1e1e] animate-in fade-in duration-300">
            <div className="p-4 border-b border-zinc-800">
                ...
                <p className="text-[10px] text-zinc-500 mt-1">
                    Automatically transcribe speech in your video.
                </p>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 text-center space-y-6">
                ...
                <div className="space-y-2">
                    <h4 className="text-zinc-200 font-medium text-sm">Auto Subtitles</h4>
                    <p className="text-zinc-500 text-xs max-w-[200px] mx-auto">
                        Analyze your video with AI to generate synchronized subtitles.
                    </p>
                </div>
            ...
            <div className="p-4 border-t border-zinc-800 bg-zinc-900/50">
                <div className="flex items-start gap-2 text-[10px] text-zinc-500">
                    ...
                    <p>Supports English and Turkish.</p>
                </div>
            </div>
        </div>
    );
